...
class Zombie:
    ...
    def build_behavior_tree(self):
        ...
        c2 = Condition('소년이 근처에 있는가?', self.is_boy_nearby1, 7)
        a6 = Action('소년한테 접근', self.move_to_boy1)
        SEQ_chase_boy1 = Sequence('소년을 도망', c2, a6)

        root = SEL_chase_or_flee = Selector('추적 또는 배회', SEQ_chase_boy, SEQ_chase_boy1,SEQ_wander)
